            ...
            <div className="flex flex-wrap gap-4">
              {profile?.location && (
                <motion.div
                  ...
                  className="flex items-center space-x-2 px-3 py-2 rounded-lg bg-cyan-500/10 border border-cyan-500/20 cursor-pointer group hover:border-cyan-500/50 transition-all"
                >
              ...
              {profile?.phone && (
                <motion.div
                  whileHover={{ scale: 1.05, x: 5 }}
                  className="flex items-center space-x-2 px-3 py-2 rounded-lg bg-blue-500/10 border border-blue-500/20 cursor-pointer group hover:border-blue-500/50 transition-all"
                >
